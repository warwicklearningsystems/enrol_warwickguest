...
class enrol_warwickguest_formelementdepartmentadd extends HTML_QuickForm_element {
    ...
    public function __construct($elementName=null, $elementLabel=null, $options=null, $attributes=null) {
        parent::__construct('departments_add', $elementLabel, $attributes);
    ...
    {
        global $OUTPUT;
        $departmentCurrentSelector = new department($this->getName(), ['plugin'=> 'enrol_warwickguest', 'enrol_instance' => $this->instance]);        
        
        $allowedDesignations = $departmentCurrentSelector->display(true);
        
        $leftArrow = $OUTPUT->larrow();
        $rightArrow = $OUTPUT->rarrow();
        $addText = get_string('add');
        $removeText = get_string('remove');
        $label = get_string('alloweddepartments', 'enrol_warwickguest');
